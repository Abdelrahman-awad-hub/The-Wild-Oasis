...
function Pagination({ count }) {
  ...
  return (
    <StyledPagination>
      ...
      <Buttons>
        <PaginationButton onClick={previousPage} disabled={currentPage === 1}><HiChevronLeft /> Previous</PaginationButton>
        <PaginationButton onClick={nextPage} disabled={currentPage === numberOfPages}>Next <HiChevronRight /></PaginationButton>
      </Buttons >
    </StyledPagination>
  )
}
